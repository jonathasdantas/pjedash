...
public class IndicadorCasosNovosBaixadosSentencasJNSrvRestClient {
	
	public Response recuperarIndicadoresPorFiltro(Integer idOrgaoJulgador) {
		return RestClientUtil.doGet(Constants.PJE2_REST_URL, Constants.REST_PATH_ICNB_JN_ORGAO, "idOrgaoJulgador", idOrgaoJulgador);
	}
	...
	public Response recuperarIndicadoresPorFiltro(Integer idOrgaoJulgador, Integer ano) {
		...
		return RestClientUtil.doGet(Constants.PJE2_REST_URL, Constants.REST_PATH_ICNB_JN_ORGAO_ANO, parametros);
	}
	...
	public Response recuperarIndicadoresPorFiltro(Integer idOrgaoJulgador, Integer ano, Integer semestre) {
		...
		return RestClientUtil.doGet(Constants.PJE2_REST_URL, Constants.REST_PATH_ICNB_JN_ORGAO_ANO_SEMESTRE, parametros);
	}
}
