...
public class IndiceAtendimentoDemandaSrvRestClient {

	public Response recuperarIndicadoresPorFiltro(Integer idOrgaoJulgador) {
		return RestClientUtil.doGet(Constants.PJE2_REST_URL, Constants.REST_PATH_IAD_ORGAO, "idOrgaoJulgador", idOrgaoJulgador);
	}
	...
	public Response recuperarIndicadoresPorFiltro(Integer idOrgaoJulgador, Integer ano) {
		...
		return RestClientUtil.doGet(Constants.PJE2_REST_URL, Constants.REST_PATH_IAD_ORGAO_ANO, parametros);
	}
	...
	public Response recuperarIndicadoresPorFiltro(Integer idOrgaoJulgador, Integer ano, Integer mes) {
		...
		return RestClientUtil.doGet(Constants.PJE2_REST_URL, Constants.REST_PATH_IAD_ORGAO_ANO_MES, parametros);
	}
}
